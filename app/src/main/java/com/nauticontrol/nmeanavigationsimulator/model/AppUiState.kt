...
data class AppUiState(
    ...
    val windDirectionText: String = "255–275°T",
    val windSpeedText: String = "10.0–13.0 kn",
    val depthText: String = "7.5–8.5 m",
    val waterTemperatureText: String = "13.0–15.0 °C",
    val currentDirectionText: String = "350–10°T",
    val currentSpeedText: String = "0.10–0.25 kn",
